...
\define('_AM_DEBUGBAR_LOGS_DESCRIPTION', 'Monolog files are stored outside the web root. The XOOPS core debug log (xoops_data/logs/debug.log, switched on in xoops_data/data/debug.php) is also shown when present, as plain text.');
