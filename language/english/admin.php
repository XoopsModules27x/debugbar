...
\define('_AM_DEBUGBAR_XOOPS_DEBUG_BY_FILE', 'Enabled by debug.php');
\define('_AM_DEBUGBAR_XOOPS_DEBUG_BY_FILE_DSC', 'DebugBar is switched on by the "debugbar" block in xoops_data/data/debug.php, which does not use the database. The button below still changes the database Debug Mode, but it cannot turn DebugBar off while that file says otherwise - remove or disable the block there instead. DebugBar never edits that file.');
\define('_AM_DEBUGBAR_DIAG_DEBUG_FILE', 'debug.php');
