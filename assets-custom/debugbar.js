...
(function () {
    ...
    PhpDebugBar.utils.copyText = async function (value) {
    ...
    class Tab extends Widget {
        ...
        render() {
            ...
            this.bindAttr('widget', function (widget) {
                this.el.innerHTML = '';
                this.copyAllToolbar = document.createElement('div');
                this.copyAllToolbar.classList.add(csscls('panel-toolbar'));
                this.copyAllButton = document.createElement('button');
                this.copyAllButton.type = 'button';
                this.copyAllButton.textContent = 'Copy All';
                this.copyAllButton.classList.add(csscls('copy-all'));
                this.copyAllButton.addEventListener('click', (event) => {
                    event.stopPropagation();
                    const data = this.get('data');
                    PhpDebugBar.utils.copyText(data).then((success) => {
                        this.copyAllButton.textContent = success ? 'Copied' : 'Copy failed';
                        window.setTimeout(() => { this.copyAllButton.textContent = 'Copy All'; }, 1200);
                    });
                });
                this.copyAllToolbar.append(this.copyAllButton);
                this.el.append(this.copyAllToolbar);
